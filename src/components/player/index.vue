...
export default {
  ...
  methods: {
    ...
    _getPosAndScale() {
      ...
      const paddingTop = 80
      const width = window.innerWidth * 0.8 // 获取 cd 的宽度
      const scale = tragetWidth / width // 初始的缩放比例
...
@import "~common/stylus/mixin"
  ...
  .player
    .normal-player
      ...
      &.slide-normal-enter-active, &.slide-normal-leave-active
        transition: all 0.4s
        .top, .bottom
          transition: all 0.4s cubic-bezier(0.86, 0.18, 0.82, 1.32)
      &.slide-normal-enter, &.slide-normal-leave-to
        opacity: 0
        .top
    ...
    .mini-player
      ...
      &.slide-mini-enter-active, &.slide-mini-leave-active
        transition: all 0.4s
      &.slide-mini-enter, &.slide-mini-leave-to
        opacity: 0
      .icon
        flex: 0 0 40px
        width: 40px
